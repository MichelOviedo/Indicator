 ...
 */
public class TabPerformance extends Fragment {
    ...
    private void builder(){
        ...
        type.setText(rs.getString(R.string.indicatorPerf));
        count.setText(rs.getString(R.string.indicatorPerfSub));
        ...
        titleEdit.setText(rs.getString(R.string.deseEdit));
    ...
    public void agregarCabecera(){
        ...
        txtNombre.setText(rs.getString(R.string.indicatorPer));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int x = 0; x < listStudent.size(); x++) {
                    ...
                    if (asistencia.size() > 0 && participacion.size() > 0 && convivencia.size() > 0)
                        if (p.getMatter().equalsIgnoreCase(rs.getString(R.string.mat)) ||
                                p.getMatter().equalsIgnoreCase(rs.getString(R.string.espa)))
                            if (p.getMatter().equalsIgnoreCase(rs.getString(R.string.mat)) && matematicas.size() > 0)
                                isFinish = 1;
                            else if (p.getMatter().equalsIgnoreCase(rs.getString(R.string.espa)) && lectura.size() > 0)
                                isFinish = 1;
                            else
                                isFinish = 0;
                        else
                    ...
                    if (despempenio.size() > 0) {
                        idEva = despempenio.get(0).getIdAllocation();
                        despempenio.get(0).setValue(ind);
                    }
                    else {
                        idEva = getPk();
