...
public class TabPerformance extends Fragment {
    ...
    private void builder() {
        ...
        RealmResults<Realm_viewTables> viewTables = realm.where(Realm_viewTables.class)
                ...
                .findAll();
        if (viewTables.get(0).getPerformance_score() <= 0) {
            viewLayoutList();
        } else {
            viewLatoutEdit();
        }
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int x = 0; x < listStudent.size(); x++) {
                    ...
                    showLog("Student: " + results.get(0).getPerformance_score());
                    ...
                    results.get(0).setPerformance_score(ind);
                    //Como sincronizar la data o bien cada cuando se debe de sincronizar
                    showLog("Student Result: " + results.get(0).getPerformance_score());
    ...
    private void viewLatoutEdit() {
        ...
        for (int x = 0; x < listStudent.size(); x++){
            ...
            if (stIndi.get(0).getPerformance_score() == 0)
                mala++;
            else
            if (stIndi.get(0).getPerformance_score() == 0.5)
                regular++;
            else
                buena++;
    ...
    private void viewLayoutList() {
        ...
        for (int x = 0; x < listStudent.size(); x++) {
            ...
            showLog("Valor de indicator: " + stIndi.get(0).getPerformance_score());
